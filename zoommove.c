...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/19 14:14:17 by mnaghdal          #+#    #+#             */
/*   Updated: 2025/07/19 14:14:17 by mnaghdal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	key_switch(int keycode, t_data *mlx)
{
...
int	key_press(int keycode, t_data *mlx)
{
	if (keycode == KEY_ESC)
	{
		...
		color_shift(mlx);
	else if (!key_switch(keycode, mlx))
		return (1);
	else
		return (1);
	draw(mlx);
